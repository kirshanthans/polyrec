...
class Completion:
    ...
    def ord_permutation(order, dim):# all combinations of codemotion output orders
        alldim = []
        for d in xrange(dim): # finding all permutations of all dimensions
